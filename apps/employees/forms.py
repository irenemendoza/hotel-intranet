...
class DepartmentForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            "name": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Ej: Recepción"}
            ),
    ...
    def __init__(self, *args, **kwargs):
        ...
        available_choices = [
            choice
            for choice in Department.ColorChoices.choices
    ...
    class Meta:
        ...
        widgets = {
            ...
            "phone": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "+34 600 000 000"}
            ),
            "dni": forms.TextInput(
                attrs={
                    "class": "form-control",
            ...
            "employee_number": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Ej: EMP001"}
            ),
            "gender": forms.Select(
                attrs={
                    "class": "form-control",
